...
class TightMazeDQNTrainer(Node):
    ...
    def __init__(self):
        ...
        # SPAWN POSITION - EXTREMELY TIGHT MAZE!
        self.start_position = np.array([0.3, 0.0])
        
        # NOTE: This maze has NO open spaces - all clearances are < 0.15m
        # Front: 0.10m, Left: 0.00m, Right: 0.00m at spawn
        # This is PIXEL-PERFECT navigation territory
